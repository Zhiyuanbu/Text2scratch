export type AuthAudience = "13_or_over" | "under_13" | "parent_guardian";
...
export function readStoredAuthAudience() {
  ...
  return isAuthAudience(stored) ? stored : null;
}
...
function isAuthAudience(value: unknown): value is AuthAudience {
  return value === "13_or_over" || value === "under_13" || value === "parent_guardian";
}
